...
*/
//generate an outline base on h1 through h6 headings in the source document.
window.addEventListener("load", makeOutline);


function makeOutline() {
      //location of the document oultine.
      var outline = document.getElementById("outline");

      //sourve document for the outline
...
function createList(source, outlineList) {
      ...
      //running total article headings
      var headNum = 0;
      ...
      for (var n = source.firstChild; n !== null; n = n.nextSibling) {
            ...
            var headNum = headings.indexOf(n.nodeName);
            if (headLevel !== -1) {
